...
<div class="page-wrapper">
    ...
    <main class="page-content">
        <div class="container-fluid">
            ...
            <form action="${pageContext.request.contextPath}/soso/charge/<%=cardNumber%>" method="post">
                充值金额：<input id="money" type="number" name="money" value="50" required onchange="checkMoney()"/>

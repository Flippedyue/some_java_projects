...
<head>
    ...
    <script>
        function checkPkg() {
            ...
            $.post({
                url: "${pageContext.request.contextPath}/login/checkpkg",
                data: {'cardNumber': $("#cardNumber").val(), 'serPackage': Package.toString()},
                dataType: "json",
        ...
        function success() {
            let Package = $("#Package").val();
            $.post({
                url: "${pageContext.request.contextPath}/soso/changePkg",
                data: {
...
<div class="page-wrapper">
    ...
    <main class="page-content">
        <div class="container-fluid">
            ...
            <form action="${pageContext.request.contextPath}/soso/<%=cardNumber%>" method="post">
                <input id="cardNumber" type="hidden" name="cardNumber" value=<%=cardNumber%>/>
                <p>
                    套餐: <select id="Package" class="form-control selectpicker" title="请选择" data-live-search="true">
                    <option></option>
                ...
                <span id="info"></span>
                <input type="submit" onclick="success()" value="提交"/>
            </form>
        </div>
    </main><!-- page-content" -->
</div><!-- page-wrapper -->
